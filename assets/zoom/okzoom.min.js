...
$(function (a) {
    var b = function (c) {
        c = c.toLowerCase();
        var d = /(chrome)[ \/]([\w.]+)/.exec(c) || /(webkit)[ \/]([\w.]+)/.exec(c) || /(opera)(?:.*version|)[ \/]([\w.]+)/.exec(c) || /(msie) ([\w.]+)/.exec(c) || c.indexOf("compatible") < 0 && /(mozilla)(?:.*? rv:([\w.]+)|)/.exec(c) || [], e = {
            browser: d[1] || "",
            version: d[2] || "0"
        };
        return b = {}, e.browser && (b[e.browser] = !0, b.version = e.version), b.chrome ? b.webkit = !0 : b.webkit && (b.safari = !0), window.$ && (a.browser = b), b
    }(navigator.userAgent), c = navigator.userAgent.match(/iPhone/i) || navigator.userAgent.match(/iPod/i), d = navigator.userAgent.match(/iPad/i), e = navigator.userAgent.match(/Android/i), f = c || d || e, g = b.safari ? "WebkitTransition" : "transition", h = b.safari ? "WebkitTransform" : "transform", i = b.safari ? "-webkit-transform" : "transform", j = b.safari ? "WebkitTransformOrigin" : "transformOrigin";
    a.fn.okzoom = function (b) {
        return b = a.extend({}, a.fn.okzoom.defaults, b), this.each(function () {
            ...
            if (e.id = "ok-loupe", e.style.position = "absolute", e.style.backgroundRepeat = "no-repeat", e.style.pointerEvents = "none", e.style.opacity = 0, e.style.zIndex = 7879, a("body").append(e), c.loupe = e, c.$el.data("okzoom", c), c.options = b, f ? (c.$el.bind("touchstart", function (b) {
                ...
                var g = navigator.userAgent, h = new RegExp("MSIE ([0-9]{1,}[.0-9]{0,})");
        ...
        if (a.initialized) {
            var c = a.options.width / 2, d = a.options.height / 2, e = f ? a.options.height : d, j = "undefined" != typeof b.pageX ? b.pageX : b.clientX + document.documentElement.scrollLeft, k = "undefined" != typeof b.pageY ? b.pageY : b.clientY + document.documentElement.scrollTop, l = -1 * Math.floor((j - a.offset.left) * a.widthRatio - c), m = -1 * Math.floor((k - a.offset.top) * a.heightRatio - d);
